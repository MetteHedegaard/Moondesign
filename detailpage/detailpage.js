...
function myFunction() {
    ...
    } else { //ellers skal stylingen v ære block 
...
// showSlides er en functio som tager variblen slideIndex som en paramter 
...
function showSlides(n) {
  ...
  let dots = document.getElementsByClassName("dot");
   // slides er en variable som ligger htlm - variablen er vores billeder
  if (n > slides.length) {
    slideIndex = 1
  }
     // hvis n er mindre end 1 er slideIndex 0slides.lenght dvs. vores 3 billeder
  if (n < 1) {
